    ...
    <nav class="navbar navbar-expand-lg navbar-truxup fixed-top">
      <div class="container">
        <a class="navbar-brand d-flex align-items-center" href="${base}index.html">
          <img src="${base}img/logo-trux-up.png" alt="Logo" width="100" height="45" class="me-2">
          <span class="fw-bold">Trux-up</span>
        </a>
        <!-- Acciones Directas (Siempre visibles en móvil) -->
        ...
        <div class="collapse navbar-collapse" id="navMain">
          <ul class="navbar-nav ms-auto mb-2 mb-lg-0 align-items-lg-center gap-lg-2 me-lg-5">
            <li class="nav-item"><a class="nav-link ${currentPage === 'index.html' ? 'active fw-bold' : ''}" href="${base}index.html">Inicio</a></li>
            <li class="nav-item"><a class="nav-link ${currentPage === 'productos.html' ? 'active fw-bold' : ''}" href="${base}productos.html">Productos</a></li>
            <li class="nav-item"><a class="nav-link ${currentPage === 'acercade.html' ? 'active fw-bold' : ''}" href="${base}acercade.html">Nosotros</a></li>
            
            <!-- Guest Links -->
            <li class="nav-item auth-guest"><a class="nav-link me-lg-5 ${currentPage === 'login.html' ? 'active fw-bold' : ''}" href="${base}login.html">Ingresar</a></li>
